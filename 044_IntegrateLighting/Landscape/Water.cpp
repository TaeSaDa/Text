...
void Water::Render()
{
	...
	//ฟ๖ลอ ImGui
	{
		ImGui::Begin("Water Option");
		ImGui::Text("vsBuffer");
		ImGui::Separator();
		ImGui::SliderFloat("WaveFrequency", &vsBuffer->Data.WaveFrequency, 0, 10);
		ImGui::SliderFloat("WaveAmplitude", &vsBuffer->Data.WaveAmplitude, 0, 10);
		ImGui::SliderFloat2("TextureScale", (float *)vsBuffer->Data.TextureScale, 0, 15);
		ImGui::SliderFloat("BumpHeight", &vsBuffer->Data.BumpHeight, 0, 10);
		ImGui::SliderFloat2("BumpSpeed", (float *)vsBuffer->Data.BumpSpeed, 0, 1);
	...
	{
		ImGui::Begin("Water Option2");
		ImGui::Text("psBuffer");
		ImGui::Separator();
		ImGui::SliderFloat4("ShallowColor", (float *)psBuffer->Data.ShallowColor, 0, 1);
		ImGui::SliderFloat4("DeepColor", (float *)psBuffer->Data.DeepColor, 0, 1);

		ImGui::SliderFloat("Bias", &psBuffer->Data.Bias, 0, 1);
		ImGui::SliderFloat("Power", &psBuffer->Data.Power, 0, 1);
		ImGui::SliderFloat("Amount", &psBuffer->Data.Amount, 0, 1);

		ImGui::SliderFloat("ShoreBlend", &psBuffer->Data.ShoreBlend, 1, 40);
		ImGui::SliderFloat("HeightRatio", &psBuffer->Data.HeightRatio, 0, 10);
